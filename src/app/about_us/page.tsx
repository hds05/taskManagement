...
export default function AboutPage() {
    return (
        <main className="px-6 py-12 text-gray-800 bg-cover" style={{ backgroundImage: "url('https://png.pngtree.com/background/20250209/original/pngtree-flowers-frame-green-paper-free-printable-picture-image_13243021.jpg')" }}>
