...
export default function VerifyEmail() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
            ...
            <h2 className='text-sm sm:text-base md:text-lg lg:text-xl bg-yellow-400 p-2 mt-1 rounded-lg break-words'>
            ...
            {error && (
                <div>
                    <h1 className="text-2xl font-bold text-red-600">Error verifying email. Please try again.</h1>
                </div>
            )}
        </div>
    );
